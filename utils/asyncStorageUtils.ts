 ...
 */
export const getMultipleAsyncStorageValues = async (keys: readonly string[]): Promise<readonly [string, string | null][]> => {
    try {
 ...
 */
export const clearMultipleAsyncStorageKeys = async (keys: readonly string[]): Promise<void> => {
    try {
